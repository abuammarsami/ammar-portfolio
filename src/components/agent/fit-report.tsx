 ...
 * Streams /api/fit as plain text and renders the report's markdown subset
 * (##, **, bullets) without a parser dependency.
 */
...
function ReportBlocks({ text }: { text: string }) {
