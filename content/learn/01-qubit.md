...
## Try it
Drag the sphere, or move the θ and φ sliders. Watch the amplitudes α and β
update, and see the probability bars follow |α|² and |β|². Notice: tilting θ
...
you're dragging is computed from them — the code is 166 lines, and it's the same
