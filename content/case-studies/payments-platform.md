...
- Create idempotency | A MediatR pipeline behavior over 13 curated high-risk endpoints, keyed by a required per-user `Idempotency-Key` header with a SHA-256 body hash — a retried "start payment" can't double-charge (ADR-0008).
